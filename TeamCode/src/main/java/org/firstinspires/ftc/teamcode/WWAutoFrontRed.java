...
public class WWAutoFrontRed extends OpMode {
    ...
    public void loop() {
        if(done){
            ...
            drive.drive(0,-0.4,0);
            odo.update();
            while(abs(odo.getPosY(DistanceUnit.CM)) < 17){
                odo.update();
                if(shooterMotor.getVelocity() <= 680){
                    shooterMotor.setPower(1);
                }else{
            ...
            drive.drive(0,0,-0.2);
            while(odo.getHeading(AngleUnit.DEGREES) > -30){
                odo.update();
                if(shooterMotor.getVelocity() <= 680){
                    shooterMotor.setPower(1);
                }else{
            ...
            delayMs(500);
            odo.update();
            while(abs(odo.getPosX(DistanceUnit.CM)) < 17){
                odo.update();
                if(shooterMotor.getVelocity() <= 680){
                    shooterMotor.setPower(1);
                }else{
            ...
            drive.drive(0,0.2,0);
            odo.update();
            while(abs(odo.getPosY(DistanceUnit.CM)) < 10){
                odo.update();
                if(shooterMotor.getVelocity() <= 680){
                    shooterMotor.setPower(1);
                }else{
            ...
            drive.drive(-0.3,0,0);
            odo.update();
            while(abs(odo.getPosX(DistanceUnit.CM)) < 30){
                odo.update();
                if(shooterMotor.getVelocity() <= 680){
                    shooterMotor.setPower(1);
                }else{
            ...
            delayMs(500);
            odo.update();
            while(abs(odo.getPosX(DistanceUnit.CM)) < 40){
                odo.update();
                if(shooterMotor.getVelocity() <= 680){
                    shooterMotor.setPower(1);
                }else{
