...
@TeleOp
public class TeleOpLTC22 extends OpMode {
    ...
    public void loop(){
        ...
        if(gamepad2.right_trigger > 0.2){//fire
            rtFire.setPower(-1);
            /*
        ...
        if(gamepad2.left_trigger > 0.2){//fire
            ltFire.setPower(1);
            /*
            double distance = getLLDistance();
            if(distance < 30){
        ...
        shooterMotor.setPower(setSpeed+inject);
